              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  {
                    com.talool.api.thrift.DealAcquire_t _elem10; // required
        ...
        if (incoming.get(0)) {
          {
            ...
            {
              com.talool.api.thrift.DealAcquire_t _elem15; // required
    ...
    private static class getDealOffers_resultStandardScheme extends StandardScheme<getDealOffers_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<com.talool.api.thrift.DealOffer_t>(_list16.size);
                  for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                  {
                    com.talool.api.thrift.DealOffer_t _elem18; // required
                    _elem18 = new com.talool.api.thrift.DealOffer_t();
                    _elem18.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getDealOffers_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (com.talool.api.thrift.DealOffer_t _iter19 : struct.success)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getDealOffers_resultTupleScheme extends TupleScheme<getDealOffers_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getDealOffers_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (com.talool.api.thrift.DealOffer_t _iter20 : struct.success)
            {
              _iter20.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<com.talool.api.thrift.DealOffer_t>(_list21.size);
            for (int _i22 = 0; _i22 < _list21.size; ++_i22)
            {
              com.talool.api.thrift.DealOffer_t _elem23; // required
              _elem23 = new com.talool.api.thrift.DealOffer_t();
              _elem23.read(iprot);
    ...
    private static class getCategories_resultStandardScheme extends StandardScheme<getCategories_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<com.talool.api.thrift.Category_t>(_list40.size);
                  for (int _i41 = 0; _i41 < _list40.size; ++_i41)
                  {
                    com.talool.api.thrift.Category_t _elem42; // required
                    _elem42 = new com.talool.api.thrift.Category_t();
                    _elem42.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCategories_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (com.talool.api.thrift.Category_t _iter43 : struct.success)
            {
              _iter43.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getCategories_resultTupleScheme extends TupleScheme<getCategories_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getCategories_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (com.talool.api.thrift.Category_t _iter44 : struct.success)
            {
              _iter44.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<com.talool.api.thrift.Category_t>(_list45.size);
            for (int _i46 = 0; _i46 < _list45.size; ++_i46)
            {
              com.talool.api.thrift.Category_t _elem47; // required
              _elem47 = new com.talool.api.thrift.Category_t();
              _elem47.read(iprot);
