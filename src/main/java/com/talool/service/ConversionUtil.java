...
public final class ConversionUtil {
  ...
  /**
   * TODO - THis needs work - we need to attach to a hibernate session (detached object)
   * 
  ...
  public static Customer convertFromThrift(Customer_t thriftCustomer) {
    ...
    if (thriftCustomer.getSocialAccounts() != null) {
      for (Entry<SocialNetwork_t, SocialAccount_t> entry : thriftCustomer.getSocialAccounts().entrySet()) {
        final CustomerSocialAccount csa = FactoryManager.get().getDomainFactory().newCustomerSocialAccount(entry.getKey().toString());
  ...
  public static SearchOptions convertFromThrift(final SearchOptions_t thriftSearchOptions) {
    ...
    if (thriftSearchOptions != null) {
      searchOptions =
          new SearchOptions.Builder().maxResults(thriftSearchOptions.getMaxResults()).page(thriftSearchOptions.getPage())
              .sortProperty(thriftSearchOptions.sortProperty).ascending(thriftSearchOptions.ascending).build();
    }
  ...
  public static void copyFromThrift(final SocialAccount_t thriftSocialAccnt, final CustomerSocialAccount socialAccnt, final Customer customer) {
  ...
  public static List<DealOffer_t> convertToThrift(final List<DealOffer> dealOffers) {
    if (!CollectionUtils.isEmpty(dealOffers)) {
      List<DealOffer_t> dealOffers_t = new LinkedList<DealOffer_t>();
  ...
  public static Location convertFromThrift(final Location_t location_t) {
    ...
    Location location = FactoryManager.get().getDomainFactory().newLocation(location_t.getLongitude(), location_t.getLatitude());
  ...
  public static CustomerSocialAccount convertFromThrift(final SocialAccount_t socialAccount_t, final Customer customer) {
    ...
    try {
      sac.setSocialNetwork(FactoryManager.get().getServiceFactory().getTaloolService()
          .getSocialNetwork(SocialNetwork.NetworkName.valueOf(socialAccount_t.getSocialNetwork().toString())));
  ...
  public static DealOffer_t convertToThrift(final DealOffer dealOffer) {
    ...
    if (dealOffer.getDealOfferBackground() != null) {
      dealOffer_t.setDealOfferBackgroundImage(dealOffer.getDealOfferBackground().getMediaUrl());
    }

    if (dealOffer.getDealOfferIcon() != null) {
      dealOffer_t.setDealOfferMerchantLogo(dealOffer.getDealOfferIcon().getMediaUrl());
    }
  ...
  public static MerchantLocation_t convertToThrift(final MerchantLocation merchantLocation) {
    ...
    if (merchantLocation.getGeometry() != null) {
      mLoc.setLocation(new Location_t(merchantLocation.getGeometry().getCoordinate().x, merchantLocation.getGeometry().getCoordinate().y));
    }
  ...
  public static List<Gift_t> convertToThriftGifts(final List<Gift> gifts) {
    ...
    final List<Gift_t> thriftGifts = new LinkedList<Gift_t>();
  ...
  public static Merchant_t convertToThrift(final Merchant merchant) {
    ...
    final List<MerchantLocation_t> locations = new LinkedList<MerchantLocation_t>();
  ...
  public static List<DealAcquire_t> convertToThriftDealAcquires(final List<DealAcquire> dealAcquires) {
    final List<DealAcquire_t> deals = new LinkedList<DealAcquire_t>();
  ...
  public static List<Merchant_t> convertToThriftMerchants(final List<Merchant> listOfMerchants) {
    final List<Merchant_t> merchants = new LinkedList<Merchant_t>();
  ...
  public static List<Deal_t> convertToThriftDeals(final List<Deal> deals) {
    ...
    final List<Deal_t> thriftDeals = new LinkedList<Deal_t>();
  ...
  public static List<Activity_t> convertToThriftActivites(final List<Activity> activities) {
    ...
    final List<Activity_t> thriftAct = new LinkedList<Activity_t>();
  ...
  public static PaymentDetail convertFromThrift(final PaymentDetail_t paymentDetail_t) {
    ...
    card.setAccountNumber(paymentDetail_t.getCard().getAccountNumber()).setSecurityCode(paymentDetail_t.getCard().getSecurityCode())
        .setExpirationMonth(paymentDetail_t.getCard().getExpirationMonth()).setExpirationYear(paymentDetail_t.getCard().getExpirationYear())
  ...
  public static List<Category_t> convertToThriftCategories(final List<Category> categories) {
    ...
    final List<Category_t> categories_t = new LinkedList<Category_t>();
  ...
  public static List<DealOfferGeoSummary_t> convertToThriftDealOfferGeoSummaries(final List<DealOfferGeoSummary> dealOfferSummaries) {
    ...
    final List<DealOfferGeoSummary_t> dealOfferGeoSummaries_t = new LinkedList<DealOfferGeoSummary_t>();
