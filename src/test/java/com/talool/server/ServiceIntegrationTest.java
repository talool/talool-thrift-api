...
public class ServiceIntegrationTest {
  ...
  public void testGiftRequests() throws ServiceException_t, TException {
    ...
    String giftId = client.giftToFacebook(dealAcquires.get(0).getDealAcquireId(), giftReceiverFbId, giftReceiverFirst + " " + giftReceiverLast);
  ...
  public void testEmailBodyRequest() throws ServiceException_t, TException {
    ...
    EmailMessageResponse_t response = client.getEmailMessage(ActivityEmailTemplateType.BasicFundRaiser.getTemplateIdAsString(), dealOfferPurchaseId);
